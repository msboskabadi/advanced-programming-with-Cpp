...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//تغییر عرض مستطیل دربرگیرنده جعبه کشویی
	...
	rect.left += 5;
	rect.right -= 3;
	//m_comboBox is a custom class derived from CComboBox
	...
	//View is changed in CToolComboBox::OnCbnSelchange()
...
BOOL CMainFrame::SwitchView(CRuntimeClass* pNewView)
{
	...
	CView* pNewActiveView = (CView*) pWnd;// STATIC_DOWNCAST(CView, CreateView(&context));  // Now we can create a new view and get rid of the previous one  
