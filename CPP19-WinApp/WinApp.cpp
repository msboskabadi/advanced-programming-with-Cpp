    ...
    case WM_COMMAND:
        {
            ...
            case IDM_EXIT:
                DestroyWindow(hWnd);
                break;
            case ID_HELP_SHOWMESSAGE:
                MessageBox(hWnd, L"سال 1402 مبارک باد", L"خوش آمدید", 0);
                break;
            default:
    ...
    case WM_PAINT:
        {
            ...
            HBRUSH br = CreateSolidBrush(RGB(250, 250, 220));
            FillRect(hdc, &rc, br);

            HBRUSH br2 = CreateSolidBrush(RGB(200, 200, 250));
            SelectObject(hdc, br2);
            Rectangle(hdc, 200, 200, 600, 400);

            SetBkMode(hdc, TRANSPARENT);
            TextOut(hdc, 210, 210, L"Happy New Year!", 15);
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
