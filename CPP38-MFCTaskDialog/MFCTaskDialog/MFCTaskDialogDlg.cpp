...
{
	CString strContent = _T("This is an important message to the students of ") \
		_T("<a href=\"http://shahroodut.ac.ir\">Shahrood University of Technology</a>.");
	CString strMainInstruction = _T("Important!\nPlease read!");
